        ...
        <footer class="p-4 bg-sharon-grey sm:p-6 ">
            <div class="mx-auto max-w-screen-xl">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm sm:text-center text-gray-400">© 2023 <Link href="/" class="hover:underline">SHARON</Link>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <Link href="#" class="text-gray-500 hover:text-white">
