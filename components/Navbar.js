    ...
    <>
      <div class="flex sm:flex-col md:flex-row flex-wrap items-center justify-around fixed z-50 px-2 sm:px-4 py-2.5 rounded bg-black  md:w-full">
        <Link href="/" class="flex items-center justify-center">
          ...
          <span class="self-center text-center text-2xl font-semibold whitespace-nowrap text-white">
            SHARON INDUSTRIES
          </span>
        </Link>
        ...
        <ul class="flex flex-row p-4 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium bg-black  md:dark:bg-black ">
          <li>
            <Link
              href="/#home"
              class="text-lg block py-2 pl-3 pr-4 text-sharon-or  rounded md:bg-transparent md:text-sharon-or md:p-0"
              aria-current="page"
            >
              Home
            </Link>
          ...
          <li>
            <Link
              href="/#about"
              class="text-lg block py-2 pl-3 pr-4  rounded md:hover:bg-transparent md:border-0 md:hover:text-sharon-or md:p-0 text-gray-400 md:dark:hover:bg-transparent"
            >
              About
            </Link>
          </li>
