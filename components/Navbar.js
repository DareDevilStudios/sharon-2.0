        ...
        <div class="flex sm:flex-col md:flex-row flex-wrap items-center justify-around fixed z-50 px-2 sm:px-4 py-2.5 rounded bg-black  md:w-full">
            ...
            {/* <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
                ...
                <ul class="flex flex-row p-4 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium bg-black  md:dark:bg-black ">
                    <li>
                        <Link href="/#home" class="text-lg block py-2 pl-3 pr-4 text-sharon-or  rounded md:bg-transparent md:text-sharon-or md:p-0" aria-current="page">Home</Link>
                    </li>
                    <li>
                        <Link href="/#about" class="text-lg block py-2 pl-3 pr-4  rounded md:hover:bg-transparent md:border-0 md:hover:text-sharon-or md:p-0 text-gray-400 md:dark:hover:bg-transparent">About</Link>
                    </li>
                    {/* <li>
